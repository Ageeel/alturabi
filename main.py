...
def main(page: ft.Page):
    ...
    page.theme = ft.Theme(
        ...
        color_scheme=ft.ColorScheme(
            primary="#f48fb1",       # اللون الوردي الفاتح للعنصر النشط/المحدد
            secondary="#ec407a",     # الوردي الأساسي للتطبيق
        )
    )
    ...
    # تحديد لغة الصفحة الأساسية كالعربية
    page.locale = "ar"
    ...
    # التعديل الجديد: تخصيص نصوص الأزرار يدوياً لتدعم العربية دون الحاجة لـ LocalizationProvider
